...
insert into employee (id, first_name, last_name, email) values (1, 'Javed', 'Bagwan', 'javedbagwan@gmail.com');
insert into employee (id, first_name, last_name, email) values (2, 'Juber', 'Shaikh', 'JShaikh@gmail.com');
insert into employee (id, first_name, last_name, email) values (3, 'Vishnu', 'Teja', 'Vishnu@gmail.com');